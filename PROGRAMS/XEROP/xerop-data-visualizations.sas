*********************************************************************                             
*                                                                   
*  PROGRAM DESCRIPTION: Visualize data from the ICHS Study;
*                                                                   
*-------------------------------------------------------------------
*  JOB NAME:       xerop-data-visualizations.sas                                   
...
%setup(XEROP-DATA-VISUALIZATIONS,C:\USERS\PSIODA\DOCUMENTS\GITHUB\BIOS-767-PROGRAMMING);
