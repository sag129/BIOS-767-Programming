*********************************************************************                             
*                                                                   
*  PROGRAM DESCRIPTION: Visualize data from the Dental Study;
*                                                                   
*-------------------------------------------------------------------
*  JOB NAME:       dental-data-visualizations.sas                                   
...
%setup(DENTAL-DATA-VISUALIZATIONS,C:\USERS\PSIODA\DOCUMENTS\GITHUB\BIOS-767-PROGRAMMING);
